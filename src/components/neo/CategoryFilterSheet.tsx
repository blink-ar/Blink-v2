...
export const CATEGORY_OPTIONS: CategoryOption[] = [
  ...
  { token: 'supermercados',   label: 'Supermercados',    icon: 'shopping_cart',          emoji: '🛒', bg: '#F0FDF4', color: '#14532D' },
  { token: 'shopping',        label: 'Shopping',         icon: 'shopping_bag',           emoji: '🛍️', bg: '#E0F2FE', color: '#0369A1' },
  { token: 'combustible',     label: 'Combustible',      icon: 'local_gas_station',      emoji: '⛽', bg: '#FFF7ED', color: '#9A3412' },
